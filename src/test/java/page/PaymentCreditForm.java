...
public class PaymentCreditForm {

    private final SelenideElement paymentForm = $("form.form");

    private final SelenideElement creditCardField = $("form div:nth-child(1) input.input__control");
    ...
    public void fillCardNumber(String cardValue) {
        creditCardField.setValue(cardValue);
    }
